...
export const PortfolioHero = ({ hero }: PortfolioHeroProps) => {
  ...
  return (
    <section className="w-full min-h-[80vh] flex items-center pt-12 lg:pt-24 pb-12 lg:pb-24 overflow-hidden border-b border-border/40">
      <div className="container mx-auto px-6 md:px-12 relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-24 lg:gap-12 items-center">
          ...
          <div className="order-1 lg:order-2 relative flex justify-center lg:justify-end">
            <div className="relative w-full max-w-[560px] 2xl:max-w-[640px] aspect-square lg:aspect-[4/5]">
              {/* Decorative elements */}
      ...
      <div className="absolute h-200px lg:h-[700px] -top-[160px] z-0 w-full left-0">
        <DarkVeil
          hueShift={0}
          noiseIntensity={0.06}
          scanlineIntensity={0}
